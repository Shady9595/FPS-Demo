...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        [SerializeField] WeaponDataObject _weaponData = null;

        public WeaponDataObject WeaponData => _weaponData;
        ...
        public float GetAmmoNeededToShoot() =>
            ...
            (_weaponData.Data.MaxAmmo * _weaponData.Data.BulletsPerShot);
        ...
        public float Damage => _weaponData.Data.Damage;
        ...
        void Awake()
        {
            m_CurrentAmmo = _weaponData.Data.MaxAmmo;
            m_CarriedPhysicalBullets = HasPhysicalBullets ? _weaponData.Data.ClipSize : 0;
        ...
        public void AddCarriablePhysicalBullets(int count) => m_CarriedPhysicalBullets = Mathf.Max(m_CarriedPhysicalBullets + count, _weaponData.Data.MaxAmmo);
        ...
        void Reload()
        {
            ...
            {
                m_CurrentAmmo = Mathf.Min(m_CarriedPhysicalBullets, _weaponData.Data.ClipSize);
            }
        ...
        void UpdateAmmo()
        {
            if (AutomaticReload && m_LastTimeShot + AmmoReloadDelay < Time.time && m_CurrentAmmo < _weaponData.Data.MaxAmmo && !IsCharging)
            {
                // reloads weapon over time
                m_CurrentAmmo += AmmoReloadRate * Time.deltaTime;

                // limits ammo to max value
                m_CurrentAmmo = Mathf.Clamp(m_CurrentAmmo, 0, _weaponData.Data.MaxAmmo);
            ...
            if (_weaponData.Data.MaxAmmo == Mathf.Infinity)
            {
                CurrentAmmoRatio = 1f;
            }
            else
            {
                CurrentAmmoRatio = m_CurrentAmmo / _weaponData.Data.MaxAmmo;
            }
        }
        ...
        {
            m_CurrentAmmo = Mathf.Clamp(m_CurrentAmmo - amount, 0f, _weaponData.Data.MaxAmmo);
            m_CarriedPhysicalBullets -= Mathf.RoundToInt(amount);
            m_CarriedPhysicalBullets = Mathf.Clamp(m_CarriedPhysicalBullets, 0, _weaponData.Data.MaxAmmo);
        ...
        bool TryBeginCharge()
        {
            if (!IsCharging
                ...
                && Mathf.FloorToInt((m_CurrentAmmo - AmmoUsedOnStartCharge) * _weaponData.Data.BulletsPerShot) > 0
                && m_LastTimeShot + DelayBetweenShots < Time.time)
            {
        ...
        void HandleShoot()
        {
            int bulletsPerShotFinal = ShootType == WeaponShootType.Charge
                ? Mathf.CeilToInt(CurrentCharge * _weaponData.Data.BulletsPerShot)
                : _weaponData.Data.BulletsPerShot;
